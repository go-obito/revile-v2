...
export default async function HomePage() {
  ...
  return <main>
    ...
    <section className="shell lower-home-section"><div className="features-column"><div className="section-heading"><h2>Features</h2><span className="section-count">From the newsroom</span></div><div className="features-grid">{featurePosts.map((post) => <PostCard key={post.id} post={post} compact />)}</div></div><aside className="classifieds-panel"><h2>Classifieds</h2><p>Classified listings are not available in Revile yet.</p></aside></section>
